...
for (year in start_year:end_year) {
  read_file_path <- sprintf("../../results/dea_te_grd/%d.csv", year)
...
write_input_file_path <- "../../results/jaccard_index_te_grd/jaccard_te_input_grd.csv"
write_output_file_path <- "../../results/jaccard_index_te_grd/jaccard_te_output_grd.csv"
write_dir_file_path <- "../../results/jaccard_index_te_grd/jaccard_te_directional_grd.csv"
