...
def section_kind(table_number):
    ...
    \caption{{Valores distancia Euclidiana - Eficiencia técnica {YEAR} ({table_number}/3)}}
...
def build_correlation_tables():
    ...
    section = f"\\subsection{{Matriz distancia Euclidiana {YEAR} }}"
    print(section + '\n')
...
# Body
PATH = '../../../results/euclidean_correlation'
YEAR = sys.argv[1]
DATA_COLUMNS = [
    'et_names',
